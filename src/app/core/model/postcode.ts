export interface PostcodeApiResponse {
    status: number;
    result: PostcodeApiInformation
}

export interface PostcodeApiInformation {
    postcode: string;
    quality: number;
...
export interface PostcodeApiBulkGeolocation {
    query: {
        longitude: number | null,
        latitude: number | null,
        radius: number | null
...
export interface PostcodeApiBulkReverseGeocoding {
    status: number,
    result: PostcodeApiBulkGeolocation[];
}
